...
# PowerBI
O dashboard foi desenvolvido no Power BI, apresentando indicadores principais, análise por canal, evolução temporal e comportamento das transações. Disponível no código como também na no arquivo PowerBi.
...
Passo 1: Download e Instalação do Driver
...
Passo 2: Configuração do DSN no Windows (ODBC)
